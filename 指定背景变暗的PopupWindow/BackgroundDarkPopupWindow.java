...
import edu.com.gaiwen.firstchoice.R;

/**
 * @author BakerJ
 可配置背景变暗动画、位置、颜色，不配置默认全屏展示暗黑色： http://blog.csdn.net/u011788083/article/details/44240389
...
public class BackgroundDarkPopupWindow extends PopupWindow {
    ...
    public BackgroundDarkPopupWindow(View contentView, int width, int height) {
        ...
        if (contentView != null) {
            ...
            mDarkView.setLayoutParams(new RelativeLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT));
    ...
    public void showUp(View v) {
        //在控件上方显示
        showAtLocation(v, Gravity.NO_GRAVITY, 0, 50);
    }
